...
module.exports = {
  ...
  theme: {
    ...
    screens: {
      sm: "(max-width: 420px)",
      mq450: "(min-width: 421px) and (max-width: 450px)",
      mq750: "(min-width: 451px) and (max-width: 750px)",
      mq1050: "(min-width: 751px) and (max-width: 1050px)",
      lg: "(min-width: 421px) and (max-width: 1200px)",
    },
  },
  corePlugins: {
    preflight: false,
